...
#define SetControlsSortida()    (TRISEbits.TRISE0 = TRISEbits.TRISE1 = TRISEbits.TRISE2 = 0)
...
#define RWUp()					(LATEbits.LATE1 = 1)
#define RWDown()				(LATEbits.LATE1 = 0)
#define EnableUp()				(LATEbits.LATE2 = 1)
#define EnableDown()            (LATEbits.LATE2 = 0)
// -------------------------------END--HARDWARE---AREA--------------------
